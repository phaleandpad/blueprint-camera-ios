//
//  ModernBlackboardCase10View.swift
//  andpad-camera
//
...
// MARK: - ModernBlackboardCase10View

final class ModernBlackboardCase10View: BlackboardBaseView {
    /// 項目のタイトル
...
extension ModernBlackboardCase10View: ModernBlackboardCaseViewProtocol {
    func configure(
        titles: [String],
        values: [String]?,
