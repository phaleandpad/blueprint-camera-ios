//
//  ModernBlackboardCase701View.swift
//  andpad-camera
//
...
// MARK: - ModernBlackboardCase701View

final class ModernBlackboardCase701View: BlackboardBaseView {
    /// 項目のタイトル
...
extension ModernBlackboardCase701View: ModernBlackboardCaseViewProtocol {
    func configure(
        titles: [String],
        values: [String]?,
