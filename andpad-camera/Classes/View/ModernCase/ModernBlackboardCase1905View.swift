//
//  ModernBlackboardCase1905View.swift
//  andpad-camera
//
...
// MARK: - ModernBlackboardCase1905View

final class ModernBlackboardCase1905View: BlackboardBaseView {
    /// 項目のタイトル
...
extension ModernBlackboardCase1905View: ModernBlackboardCaseViewProtocol {
    func configure(
        titles: [String],
        values: [String]?,
