//
//  ModernBlackboardCase2203View.swift
//  andpad-camera
//
...
// MARK: - ModernBlackboardCase2203View

final class ModernBlackboardCase2203View: BlackboardBaseView {
    /// 項目のタイトル
...
extension ModernBlackboardCase2203View: ModernBlackboardCaseViewProtocol {
    func configure(
        titles: [String],
        values: [String]?,
