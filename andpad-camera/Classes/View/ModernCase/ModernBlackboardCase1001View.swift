//
//  ModernBlackboardCase1001View.swift
//  andpad-camera
//
...
// MARK: - ModernBlackboardCase1001View

final class ModernBlackboardCase1001View: BlackboardBaseView {
    /// 項目のタイトル
...
extension ModernBlackboardCase1001View: ModernBlackboardCaseViewProtocol {
    func configure(
        titles: [String],
        values: [String]?,
