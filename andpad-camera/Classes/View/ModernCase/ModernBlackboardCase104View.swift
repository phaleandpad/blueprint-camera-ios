//
//  ModernBlackboardCase104View.swift
//  andpad-camera
//
...
// MARK: - ModernBlackboardCase104View

final class ModernBlackboardCase104View: BlackboardBaseView {
    /// 項目のタイトル
...
extension ModernBlackboardCase104View: ModernBlackboardCaseViewProtocol {
    func configure(
        titles: [String],
        values: [String]?,
