//
//  ModernBlackboardCase1902View.swift
//  andpad-camera
//
//  Created by 成瀬 未春 on 2024/02/10.
//

import Foundation
import UIKit

// MARK: - ModernBlackboardCase1902View

final class ModernBlackboardCase1902View: BlackboardBaseView {
    /// 項目のタイトル
...
extension ModernBlackboardCase1902View: ModernBlackboardCaseViewProtocol {
    func configure(
        titles: [String],
        values: [String]?,
