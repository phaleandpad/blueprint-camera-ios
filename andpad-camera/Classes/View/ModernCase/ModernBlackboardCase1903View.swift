//
//  ModernBlackboardCase1903View.swift
//  andpad-camera
//
...
// MARK: - ModernBlackboardCase1903View

final class ModernBlackboardCase1903View: BlackboardBaseView {
    /// 項目のタイトル
...
extension ModernBlackboardCase1903View: ModernBlackboardCaseViewProtocol {
    func configure(
        titles: [String],
        values: [String]?,
