//
//  ModernBlackboardCase1004View.swift
//  andpad-camera
//
...
// MARK: - ModernBlackboardCase1004View

final class ModernBlackboardCase1004View: BlackboardBaseView {
    /// 項目のタイトル
...
extension ModernBlackboardCase1004View: ModernBlackboardCaseViewProtocol {
    func configure(
        titles: [String],
        values: [String]?,
