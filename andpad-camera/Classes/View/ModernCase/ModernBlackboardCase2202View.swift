//
//  ModernBlackboardCase2202View.swift
//  andpad-camera
//
...
// MARK: - ModernBlackboardCase2202View

final class ModernBlackboardCase2202View: BlackboardBaseView {
    /// 項目のタイトル
...
extension ModernBlackboardCase2202View: ModernBlackboardCaseViewProtocol {
    func configure(
        titles: [String],
        values: [String]?,
