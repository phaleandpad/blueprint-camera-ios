//
//  ModernBlackboardCase704View.swift
//  andpad-camera
//
...
// MARK: - ModernBlackboardCase704View

final class ModernBlackboardCase704View: BlackboardBaseView {
    /// 項目のタイトル
...
extension ModernBlackboardCase704View: ModernBlackboardCaseViewProtocol {
    func configure(
        titles: [String],
        values: [String]?,
