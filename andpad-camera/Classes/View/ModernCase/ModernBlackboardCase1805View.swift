//
//  ModernBlackboardCase1805View.swift
//  andpad-camera
//
//  Created by Toru Kuriyama on 2023/06/21.
//

// MARK: - ModernBlackboardCase1805View
final class ModernBlackboardCase1805View: BlackboardBaseView {
    ...
    @IBOutlet private weak var alignRightValue: UILabel!
}

extension ModernBlackboardCase1805View: ModernBlackboardCaseViewProtocol {
    func configure(
        titles: [String],
        values: [String]?,
